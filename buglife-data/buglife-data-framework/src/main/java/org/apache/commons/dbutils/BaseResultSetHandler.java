 ...
 * variable inside the {@link ResultSetHandler#handle(java.sql.ResultSet)} over and over for each iteration
...
public abstract class BaseResultSetHandler<T> implements ResultSetHandler<T> {
     ...
     * @see {@link ResultSetHandler#handle(java.sql.ResultSet)}
     */
     ...
     * @param x
     * @throws java.sql.SQLException
     * @see java.sql.ResultSet#updateArray(String, java.sql.Array)
     */
     ...
     * @param x
     * @throws java.sql.SQLException
     * @see java.sql.ResultSet#updateBigDecimal(String, java.math.BigDecimal)
     */
     ...
     * @param x
     * @throws java.sql.SQLException
     * @see java.sql.ResultSet#updateBlob(String, java.sql.Blob)
     */
     ...
     * @param x
     * @throws java.sql.SQLException
     * @see java.sql.ResultSet#updateClob(String, java.sql.Clob)
     */
     ...
     * @param nClob
     * @throws java.sql.SQLException
     * @see java.sql.ResultSet#updateNClob(String, java.sql.NClob)
     */
     ...
     * @param reader
     * @throws java.sql.SQLException
     * @see java.sql.ResultSet#updateNClob(String, java.io.Reader)
     */
     ...
     * @param x
     * @throws java.sql.SQLException
     * @see java.sql.ResultSet#updateRef(String, java.sql.Ref)
     */
     ...
     * @param x
     * @throws java.sql.SQLException
     * @see java.sql.ResultSet#updateRowId(String, java.sql.RowId)
     */
     ...
     * @param xmlObject
     * @throws java.sql.SQLException
     * @see java.sql.ResultSet#updateSQLXML(String, java.sql.SQLXML)
     */
