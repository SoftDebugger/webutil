...
public class AsyncQueryRunner extends AbstractQueryRunner {
    ...
    /**
     * Executes {@link QueryRunner#insert(java.sql.Connection, String, ResultSetHandler)} asynchronously.
     *
     * @see QueryRunner#insert(java.sql.Connection, String, ResultSetHandler)
     * @throws java.sql.SQLException if a database access error occurs
     * @since 1.6
     */
    ...
    /**
     * Executes {@link QueryRunner#insert(java.sql.Connection, String, ResultSetHandler, Object...)} asynchronously.
     *
     * @see QueryRunner#insert(java.sql.Connection, String, ResultSetHandler, Object...)
     * @throws java.sql.SQLException if a database access error occurs
     * @since 1.6
     */
    ...
    /**
     * {@link QueryRunner#insertBatch(java.sql.Connection, String, ResultSetHandler, Object[][])} asynchronously.
     *
     * @see QueryRunner#insertBatch(java.sql.Connection, String, ResultSetHandler, Object[][])
     * @throws java.sql.SQLException if a database access error occurs
     * @since 1.6
     */
