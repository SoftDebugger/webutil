...
public class BasicRecordProcessor implements RecordProcessor {
     ...
     */
    private static final BasicRecordProcessor instance = new BasicRecordProcessor();
     ...
     */
    @Deprecated
    public static BasicRecordProcessor instance() {
        return instance;
    }
    ...
    /**
     * BasicRecordProcessor constructor.  Bean processing defaults to a
    ...
    /**
     * BasicRecordProcessor constructor.
     * @param convert The BeanProcessor to use when converting columns to
     * bean properties.
     * @since DbUtils 1.1
     */
    public BasicRecordProcessor(BeanProcessor convert) {
        super();
     ...
     * for key, whereas {@link java.util.LinkedHashMap} does, because of the code:
     * <pre>
